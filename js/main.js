            ...
            for(let i = 0; i < textoAtual.length; i++){
                switch(true){
                    ...
                    case textoAtual[i] == " ":
                            ...
                            break;
                    default:
                            textoNovo="Não foi possivel realizar a criptografia: caracter invalido."
                    }
                }
    ...
    for(let i= 0; i < textoEncriptado.length; i++){
            ...
            case textoEncriptado[i] == "OO":
                    textoEncriptado[i]=(" ")
                     break;
            default:
                    textoEncriptado="Não foi possivel realizar a descriptografia: caracter invalido.";
            }
    }
}
